...
class ProcessingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GeoRegister = channel.unary_unary(
                ...
                request_serializer=processing__service__v2__pb2.GeoRegistrationRequest.SerializeToString,
                response_deserializer=processing__service__v2__pb2.GeoRegistrationResponse.FromString,
                )
        self.Infer = channel.unary_unary(
                '/aip.processor.v2.ProcessingService/Infer',
                request_serializer=processing__service__v2__pb2.InferenceRequest.SerializeToString,
                response_deserializer=processing__service__v2__pb2.InferenceResponse.FromString,
                )
        self.Track = channel.unary_unary(
                '/aip.processor.v2.ProcessingService/Track',
                request_serializer=processing__service__v2__pb2.TrackRequest.SerializeToString,
                response_deserializer=processing__service__v2__pb2.InferenceResponse.FromString,
                )
...
def add_ProcessingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GeoRegister': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=processing__service__v2__pb2.GeoRegistrationRequest.FromString,
                    response_serializer=processing__service__v2__pb2.GeoRegistrationResponse.SerializeToString,
            ),
            'Infer': grpc.unary_unary_rpc_method_handler(
                    servicer.Infer,
                    request_deserializer=processing__service__v2__pb2.InferenceRequest.FromString,
                    response_serializer=processing__service__v2__pb2.InferenceResponse.SerializeToString,
            ),
            'Track': grpc.unary_unary_rpc_method_handler(
                    servicer.Track,
                    request_deserializer=processing__service__v2__pb2.TrackRequest.FromString,
                    response_serializer=processing__service__v2__pb2.InferenceResponse.SerializeToString,
            ),
    }
...
class ProcessingService(object):
    ...
    def GeoRegister(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/aip.processor.v2.ProcessingService/GeoRegister',
            processing__service__v2__pb2.GeoRegistrationRequest.SerializeToString,
            processing__service__v2__pb2.GeoRegistrationResponse.FromString,
    ...
    def Infer(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/aip.processor.v2.ProcessingService/Infer',
            processing__service__v2__pb2.InferenceRequest.SerializeToString,
            processing__service__v2__pb2.InferenceResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Track(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/aip.processor.v2.ProcessingService/Track',
            processing__service__v2__pb2.TrackRequest.SerializeToString,
            processing__service__v2__pb2.InferenceResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
